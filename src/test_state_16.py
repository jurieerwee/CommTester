...
''''
Tests the PRIME state sequence, termimating with forwardFlow into ERROR from PRIME2.
**Set pressure**
...
with open("/home/jurie/cpp_projects/tests/outputs/state_test2.out","wb") as outputFile:
	...
	while True:
		try:
			...
			t_flowSim = threading.Thread(target=flowSim.flowSim,args=(True,10))	#Forward flow instread of reverse
			t_flowSim.start()			
